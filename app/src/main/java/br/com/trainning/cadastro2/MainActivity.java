...
public class MainActivity extends AppCompatActivity {
    ...
    EditText editTextnomeCategoria;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextnomeProduto = (EditText) findViewById(R.id.nomeProduto);
        editTextnomeCategoria = (EditText) findViewById(R.id.nomeCategoria);
        editTextcodigoBarras = (EditText) findViewById(R.id.codigoBarras);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String codigoBarras = editTextcodigoBarras.getText().toString();
